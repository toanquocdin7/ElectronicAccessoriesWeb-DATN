      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Trang người dùng</a>
          </div>
              ...
              <div class="card-body">
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <a href="{{ url('backend/users/create') }}" class="btn btn-primary">Thêm</a>
                    @foreach($data as $row)
                    <tr>
                        <td>{{ $row->name }}</td>
                        <td>{{ $row->email }}</td>
                        <td style="text-align: center;">
                            <a href="{{ url('backend/users/update/'.$row->id) }}">Sửa</a>&nbsp;
                            <a href="{{ url('backend/users/delete/'.$row->id) }}" onclick="return window.confirm('Bạn chắc chưa?');">Xóa</a>
                        </td>
                    </tr>
                    @endforeach
                  </table>
