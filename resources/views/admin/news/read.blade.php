      ...
      <nav class="navbar navbar-expand-lg navbar-absolute fixed-top navbar-transparent">
        <div class="container-fluid">
          <div class="navbar-wrapper">
            ...
            <a class="navbar-brand" href="javascript:;">Trang tin tức</a>
          </div>
                    ...
                    <div class="panel-body">
                        <table style="text-align: center;" class="table table-bordered table-hover">
                            ...
                            <tr>
                                ...
                                <td style="text-align:center;">
                                    <a class="btn btn-success" style="width: 100px; " href="{{ url('backend/news/update/'.$row->id) }}">Edit</a>&nbsp;
                                    <a class="btn btn-danger" style="width: 100px" href="{{ url('backend/news/delete/'.$row->id) }}" onclick="return window.confirm('Are you sure?');">Delete</a>
                                </td>
                            </tr>
                            @endforeach
                        </table>
